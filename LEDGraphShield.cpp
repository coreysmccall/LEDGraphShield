...
/*
  ...
  _module values:
   ...
   0 -> RY _module
*/
LEDGraphShield::LEDGraphShield(int module)
{
...
*/
void LEDGraphShield::set_bar(int loc)
{
  _position=loc;
}
...
*/
void LEDGraphShield::set_ybar(int loc){
  for (int i=0;i<10;i++)
    _bufferY[i]=(loc==i);
}
...
*/
void LEDGraphShield::set_bars(int loc, boolean value){
  _bufferR[loc]=value;
}
...
*/
void LEDGraphShield::set_ybars(int loc, boolean value){
  _bufferY[loc]=value;
}
...
/*
  sets the red graph buffer to show a single bar at location (loc)
*/
void LEDGraphShield::set_bars_cum(int loc){
  for(int i=0;i<100;i++)
    _bufferR[i]=(i<=loc); 
}
...
*/
void LEDGraphShield::update_bar() {
...
*/
void LEDGraphShield::update_bars(){
...
*/
void LEDGraphShield::pulse_data(boolean value){
